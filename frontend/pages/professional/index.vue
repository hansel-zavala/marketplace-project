    ...
    <div class="container mx-auto px-4">
      ...
      <div v-else-if="!profile" class="max-w-3xl mx-auto">
        <div class="text-center mb-10">
          ...
          <p class="text-gray-600 mt-2 text-lg">Comienza a ofrecer tus servicios y llega a miles de clientes.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="space-y-6">
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div v-if="profile.verification_status === 'verified'" class="flex items-center gap-2 text-green-600 bg-green-50 p-3 rounded-lg">
                <BadgeCheck :size="24" />
                <span class="font-medium">Perfil Verificado</span>
              </div>

              <div v-else-if="profile.verification_status === 'pending'" class="flex items-center gap-2 text-yellow-600 bg-yellow-50 p-3 rounded-lg">
                <Clock :size="24" />
              ...
              <div v-else>
                ...
                <p class="text-sm text-gray-600 mb-4">Verifica tu identidad para obtener el check azul y aparecer primero en las búsquedas.</p>
                <NuxtLink to="/professional/verification" class="block w-full text-center bg-gray-900 text-white py-2 rounded-lg hover:bg-gray-800 transition font-medium">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div class="flex justify-between items-center">
                ...
                <span class="font-bold flex items-center gap-1">
                  {{ profile.rating || '0.0' }} <Star :size="14" class="text-yellow-400 fill-current" />
                </span>
              </div>
            </div>
          </div>
