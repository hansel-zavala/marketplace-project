  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else>
        <div class="relative h-64 md:h-80 bg-gray-800">
            ...
            />
            <div v-else class="w-full h-full flex items-center justify-center bg-gradient-to-r from-gray-700 to-gray-900 text-white/20">
                <Store :size="80" />
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden pb-8">
                <div class="px-6 md:px-10">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-12 mb-6">
                        <div class="w-32 h-32 rounded-xl border-4 border-white bg-white shadow-md overflow-hidden flex items-center justify-center shrink-0">
                            <img 
                                v-if="business.logo" 
                        ...
                        <div class="flex-grow pb-2">
                            <h1 class="text-3xl font-bold text-gray-900 mb-1 flex items-center gap-2">
                                ...
                                <span v-if="business.verification_status === 'verified'" class="text-blue-500" title="Negocio Verificado">
                                    <BadgeCheck :size="24" fill="currentColor" class="text-blue-100" />
                                </span>
                            </h1>
                            <div class="flex flex-wrap gap-3 text-sm text-gray-600">
                                <span v-if="business.rating > 0" class="flex items-center gap-1 font-bold text-gray-800 bg-yellow-50 px-2 py-1 rounded">
                        ...
                        <div class="flex gap-3 w-full md:w-auto mt-4 md:mt-0">
                             <button class="flex-1 md:flex-none bg-blue-600 text-white px-6 py-2.5 rounded-lg font-bold shadow-sm hover:bg-blue-700 transition flex items-center justify-center gap-2">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
                            ...
                            <div class="border-t border-gray-100 pt-6">
                                ...
                                <ul class="space-y-4 text-sm text-gray-600">
                                    ...
                                    <li v-if="business.website" class="flex items-center gap-3">
                                        ...
                                        <a :href="business.website" target="_blank" class="text-blue-600 hover:underline truncate">{{ business.website }}</a>
                                    </li>
                                    <li v-if="business.tax_id" class="flex items-center gap-3">
                                        <FileText :size="18" class="text-gray-400 shrink-0" />
                                        <span class="font-mono text-xs text-gray-500">RTN: {{ business.tax_id }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl p-12 text-center">
                                ...
                                <p class="text-gray-400 text-sm mt-1">¡Vuelve pronto para ver nuestras ofertas!</p>
                            </div>
                        </div>
...
<script setup>
import { 
    Loader2, Store, BadgeCheck, Star, MessageCircle, Edit, 
    Info, MapPin, Phone, Globe, FileText, Package, ShoppingBag 
